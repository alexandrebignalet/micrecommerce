package com.me.catalog.web.rest;

import com.me.catalog.CatalogApp;

import com.me.catalog.domain.Category;
import com.me.catalog.domain.Image;
import com.me.catalog.domain.Product;
import com.me.catalog.domain.Tag;
import com.me.catalog.repository.ProductRepository;
import com.me.catalog.service.ProductService;
import com.me.catalog.service.dto.ProductDTO;
import com.me.catalog.service.mapper.ProductMapper;
import com.me.catalog.web.rest.errors.ExceptionTranslator;
...
public class ProductResourceIntTest {
    ...
    @Test
    public void checkCategoriesIsNotEmpty() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
    ...
    @Test
    public void checkImagesIsNotEmpty() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
