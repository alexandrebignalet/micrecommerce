...
import com.me.catalog.web.rest.util.HeaderUtil;
import com.me.catalog.web.rest.util.PaginationUtil;
...
public class ImageResource {
    ...
    @GetMapping("/images")
    @Timed
    public ResponseEntity<List<ImageDTO>> getAllImages(@ApiParam Pageable pageable) {
