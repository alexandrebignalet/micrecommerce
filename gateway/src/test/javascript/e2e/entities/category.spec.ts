...
describe('Category e2e test', () => {
    ...
    it('should load Categories', () => {
        ...
        expect(categoryComponentsPage.getTitle()).toMatch(/gatewayApp.category.home.title/);
    ...
    it('should load create Category dialog', () => {
        ...
        expect(categoryDialogPage.getModalTitle()).toMatch(/gatewayApp.category.home.createOrEditLabel/);
